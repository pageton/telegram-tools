...
export async function getMe(client: TelegramClient): Promise<{ id: number; isBot: boolean; firstName: string; username?: string }> {
  const me = await client.getMe();
  return {
    id: Number(me.id),
    isBot: !!me.bot,
    firstName: (me as any).firstName || (me as any).first_name || 'Unknown',
